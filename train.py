...
if __name__ == '__main__':
     ...
     parser.add_argument('--polyak', type=float, default=1 - 1e-3) # -> rho = \tau -1 (multiplies target)
     parser.add_argument('--steps-per-epoch', type=int, default=800 * 751)
     parser.add_argument('--pi-lr', type=float, default=1e-4)
     parser.add_argument('--q-lr', type=float, default=1e-3)
     parser.add_argument('--batch-size', type=int, default=128)
     parser.add_argument('--start-steps', type=int, default=0)
     parser.add_argument('--update-after',  type=int, default=751 * 4)
     ...
     parser.add_argument('--noise-max-sigma', type=float, default=0.3)
     parser.add_argument('--noise-min-sigma', type=float, default=0.01)
